      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá gerenciar todas as unidades da sua rede.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <MapPin className="h-24 w-24 mx-auto mb-4 text-muted-foreground" />
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                <li>• Cadastrar novas unidades</li>
                <li>• Editar informações das unidades</li>
                <li>• Configurar horários de funcionamento</li>
                <li>• Gerenciar endereços e contatos</li>
                <li>• Relatórios por unidade</li>
              </ul>
              <Button
                className="mt-6"
