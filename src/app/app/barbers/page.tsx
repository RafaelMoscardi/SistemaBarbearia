      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá gerenciar toda sua equipe de barbeiros.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                <li>• Cadastrar novos barbeiros</li>
                <li>• Editar perfis e informações</li>
                <li>• Configurar comissões e pagamentos</li>
                <li>• Gerenciar horários de trabalho</li>
