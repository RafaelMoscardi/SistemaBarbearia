  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <CardTitle>Centro Financeiro</CardTitle>
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá gerenciar todas as finanças da barbearia.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <DollarSign className="h-24 w-24 mx-auto mb-4 text-muted-foreground" />
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                ...
                <li>• Pagamentos dos barbeiros</li>
