      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá configurar todos os aspectos do sistema.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Settings className="h-24 w-24 mx-auto mb-4 text-muted-foreground" />
              <h3 className="text-lg font-semibold mb-2">Página em Construção</h3>
              <p className="text-muted-foreground mb-6">
                Configurações que estarão disponíveis:
              </p>
