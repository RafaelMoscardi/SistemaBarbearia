      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá gerenciar todo o catálogo de serviços.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Scissors className="h-24 w-24 mx-auto mb-4 text-muted-foreground" />
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                <li>• Cadastrar novos serviços</li>
                <li>• Editar preços e descrições</li>
                <li>• Configurar duração dos serviços</li>
                <li>• Organizar categorias</li>
                <li>• Promoções e descontos</li>
                <li>• Análise de popularidade</li>
              </ul>
              <Button
                className="mt-6"
