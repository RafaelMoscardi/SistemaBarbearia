      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá avaliar seus atendimentos e ver suas avaliações anteriores.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Star className="h-24 w-24 mx-auto mb-4 text-muted-foreground" />
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                <li>• Avaliar atendimentos realizados</li>
                <li>• Dar nota aos barbeiros</li>
                <li>• Deixar comentários detalhados</li>
                <li>• Ver histórico de avaliações</li>
                <li>• Avaliar ambiente e atendimento</li>
