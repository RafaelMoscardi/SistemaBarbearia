      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá gerenciar sua carteirinha digital e planos.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <CreditCard className="h-24 w-24 mx-auto mb-4 text-muted-foreground" />
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                <li>• Visualizar carteirinha digital</li>
                <li>• Gerenciar planos ativos</li>
                <li>• Renovar assinaturas</li>
                <li>• Ver benefícios inclusos</li>
                <li>• Histórico de pagamentos</li>
                <li>• Upgrade de planos</li>
              </ul>
              <Button
                className="mt-6"
