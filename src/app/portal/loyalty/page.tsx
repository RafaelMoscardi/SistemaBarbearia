      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá acompanhar seus pontos e resgatar recompensas.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Gift className="h-24 w-24 mx-auto mb-4 text-muted-foreground" />
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                <li>• Acompanhar pontos acumulados</li>
                <li>• Ver histórico de pontuação</li>
                <li>• Catálogo de recompensas</li>
                <li>• Resgatar prêmios e descontos</li>
                <li>• Níveis de fidelidade</li>
