      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esta página está em desenvolvimento. Em breve você poderá fazer seus agendamentos online.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              ...
              <ul className="text-left space-y-2 max-w-md mx-auto text-muted-foreground">
                <li>• Escolher unidade</li>
                <li>• Selecionar barbeiro preferido</li>
                <li>• Escolher serviços desejados</li>
                <li>• Visualizar horários disponíveis</li>
                <li>• Confirmar agendamento</li>
                <li>• Receber confirmação via WhatsApp</li>
              </ul>
              <Button
                className="mt-6"
