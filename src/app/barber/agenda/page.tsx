...
import { Calendar, Clock, User, Phone, ChevronLeft, Plus, Filter, Search, Check, X } from 'lucide-react'
            ...
            <div className="grid grid-cols-7 gap-2">
              {[0, 1, 2, 3, 4, 5, 6].map((dayOffset) => {
                ...
                return (
                  <div
                    key={dayOffset}
                    className="text-center p-3 rounded-lg border hover:bg-accent/50 cursor-pointer transition-colors"
